...
oc create -f ../cmd/perceptor-scanner/perceptor-scanner-serviceaccount.yaml --namespace=bds-perceptor
...
oc create -f ../cmd/perceptor-scanner/perceptor-scanner.yaml --namespace=bds-perceptor
